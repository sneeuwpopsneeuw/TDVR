...
public class MechAnimation : MonoBehaviour {
    ...
    void FixedUpdate (){
        ...
        //    newAnimTime = Mathf.Repeat(GetComponent<Animation>()[walk.name].normalizedTime * 2 + 0.1f, 1);
	    //	//FIXME_VAR_TYPE newAnimTime= Mathf.Repeat (GetComponent<Animation>()[walk.name].normalizedTime * 2 + 0.1f, 1);
