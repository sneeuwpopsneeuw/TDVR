...
void Awake (){
	...
	if (damagePrefab) {
		...
		Vector2 tempSize = Vector2(GetComponent.<Collider>().bounds.extents.x,GetComponent.<Collider>().bounds.extents.z);
